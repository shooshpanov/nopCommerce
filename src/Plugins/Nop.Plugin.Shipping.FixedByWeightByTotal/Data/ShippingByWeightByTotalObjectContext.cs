...
namespace Nop.Plugin.Shipping.FixedByWeightByTotal.Data
{
    ...
    public class ShippingByWeightByTotalObjectContext : DbContext, IDbContext
    {
        ...
        public ShippingByWeightByTotalObjectContext(DbContextOptions<ShippingByWeightByTotalObjectContext> options) : base(options)
        {
        }
        ...
        {
            //drop the table
            this.DropPluginTable(nameof(ShippingByWeightByTotalRecord));
        }
